...
export function createRoad() {
  ...
  const road1 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 100), roadMat);
  road1.rotation.x = -Math.PI / 2;

  const road2 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 130), roadMat);
  road2.rotation.x = -Math.PI / 2;
  road2.rotation.z = Math.PI / 2;


  const road3 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 120), roadMat);
  road3.rotation.x = -Math.PI / 2;

  const road4 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 110), roadMat);
  road4.rotation.x = -Math.PI / 2;
  road4.rotation.z = Math.PI / 2;


  const road5 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 50), roadMat);
  road5.rotation.x = -Math.PI / 2;

  const road6 = new THREE.Mesh(new THREE.PlaneBufferGeometry(roadWidth, 100), roadMat);
