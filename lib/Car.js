export default class Car {
  ...
  constructor(maxSpeed, acceleration, brakePower, turningRadius, keys) {
    ...
    this.controlKeys = { LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, BRAKE: 32 };
  ...
  update( delta ) {
    ...
    // wheels rolling
    let angularSpeedRatio = -2 / this.wheelDiameter;

    let wheelDelta = forwardDelta * angularSpeedRatio * length;
  ...
  computeDimensions() {
    let bb = new THREE.Box3().setFromObject( this.frontLeftWheelRoot );
